...
REM
REM Generated by Vivado on Mon Apr 01 19:44:56 +0800 2024
...
call xsim  tb_reg_file_behav -key {Behavioral:sim_1:Functional:tb_reg_file} -tclbatch tb_reg_file.tcl -log simulate.log
